...
├── 📄 faq                      частые вопросы
├── 📄 провайдеры               Claude, Ollama, MCP vs API
├── 📄 конфиг-уровни            global vs project — что где
├── 📄 универсальный-воркфлоу   подход для любой задачи / машины
├── 📄 обслуживание             чек-листы при добавлении нового
├── 📂 концепции/
...
- [[провайдеры]] — какие модели подключить (Claude, Ollama, OpenRouter)
- [[конфиг-уровни]] — что хранить глобально, а что в проекте
- [[workflow/взгляд-агента]] — как агент думает и принимает решения

## Применение системы

- [[универсальный-воркфлоу]] — подход для любой задачи на любой машине
- [[обслуживание]] — чек-листы при добавлении провайдера/MCP/агента
