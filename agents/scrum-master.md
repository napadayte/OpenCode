...
> **Recommended model tier:** fast (haiku-tier — cheap, low-latency)
> - Anthropic: `anthropic/claude-haiku-4-5`
> - OpenAI: `openai/gpt-4o-mini` or `openai/gpt-5-mini`
> - Gemini: `google/gemini-2-flash`
>
> Override with `model:` in frontmatter if needed. Without `model:` the agent inherits your `default_agent`'s model.
